...
[![Actions Status](https://github.com/matthiasthe1/python-project-lvl1/workflows/Linter/badge.svg)](https://github.com/matthiasthe1/python-project-lvl1/actions)
...
The first study project on Python Developer course (by Hexlet.io)
It contains a few elementary games 3 rounds each. Make no mistake to win. Description of an each one is given below

## Install

To install and play games use commands from rthe makefile.
```jsx
make install
make publish
...
R.Anisimov <r.anisimov.esq@gmail.com>

## Repository

<https://github.com/matthiasthe1/python-project-lvl1>
